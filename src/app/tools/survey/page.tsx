    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setResponseMessage(
                    result.error || "Failed to submit your response.",
                );
            }
        } catch (error) {
        ...
        <>
            ...
            <main className="p-4 bg-gray-50 min-h-screen">
                <div className="text-2xl font-bold mb-0">
                    <h1>
                        You are invited to come to Luyang&apos;s Birthday Party!
                    </h1>
                </div>
                <div className="mb-6">
                ...
                <div className="max-w-xl mx-auto bg-white p-6 shadow-lg rounded-lg">
                    <div className="text-2xl font-bold mb-4">
                        <p>
                            Do you intend to come to my birthday party? (No
                            pressure of course)
                        </p>
                    </div>
                    <form
