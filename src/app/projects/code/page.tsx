...
export const metadata: Metadata = {
    ...
    description:
        "My coding projects outside of work that are either from uni, self-interest or for fun.",
};
...
const projects: CodingProjects = {
    ...
    projectsWithContributions: [
        ...
        },
        {
            ...
            repoName: "airflow",
            repoOwner: "apache",
            image: "https://yt3.ggpht.com/a/AATXAJx6O-PMzOLwS4y2neaSR0_dfV3rmJbrMHPHlg=s900-c-k-c0xffffffff-no-rj-mo",
            tags: [],
        },
    ],
};

const CodingProjectsPage: React.FC<{}> = async () => {
    const { heading, description } = heroHeaderContent;
    return (
        <main>
            <HeroHeader heading={heading} description={description} />
            <Gallery
                heading="Noteworthy Coding Projects"
                content={projects.projectsICreated}
            />
            <Gallery
                heading="Coding Projects that I Have Contributed to"
                content={projects.projectsWithContributions}
            />
        </main>
    );
};
