...
export const metadata: Metadata = {
  title: "Luyang's Website | Hardware Projects",
  description:
...
const HardwareProjectsPage: React.FC<{}> = () => {
  const heroHeaderContent = Object.freeze({
    ...
    description:
      "I used these hardware components and my arduino for past competitions and also my personal projects. I will release the videos of the projects here soon as well.",
  }); // as const
  ...
  return (
    <main>
      ...
      <Gallery
        heading="3D Hardware that I Use for My Projects"
        content={content}
      />
    </main>
  );
