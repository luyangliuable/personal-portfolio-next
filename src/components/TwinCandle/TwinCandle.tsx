...
class TwinCandles extends Component<ITwinCandleProps, ITwinCandleState> {
    ...
    this.state = {
      ...
      fireOnState: {
        ...
        candleTwoFire: {
          ...
          className: ["candle2__fire", "candle2__fire-animated"],
        },
        candleOneSmokeOne: {
      ...
      fireOffTransitionState: {
        ...
        candleOneEyesOne: {
          reference: this.candleOneEyesOneRef,
          className: ["candle1__eyes-one", "candle1__eyes-one-animated"],
        },
        candleOneEyesTwo: {
          reference: this.candleOneEyesTwoRef,
          className: ["candle1__eyes-two", "candle1__eyes-two-animated"],
        },
        candleOneMouth: {
          reference: this.candleOneMouthRef,
          className: ["candle1__mouth", "candle1__mouth-animated"],
        },
        candleTwo: {
          reference: this.candleTwoRef,
          className: ["candle2"],
        ...
        candleTwoFire: {
          reference: this.candleTwoFireRef,
          className: ["candle2__fire", "candle2__fire-transition__off"],
        },
        candleOneSmokeOne: {
          reference: this.candleOneSmokeOneRef,
      ...
      fireOnTransitionState: {
        ...
        candleTwo: {
          reference: this.candleTwoRef,
          className: ["candle2", "candle2-transition__on"],
        },
        candleTwoEyesOne: {
          reference: this.candleTwoEyesOneRef,
        ...
        candleTwoFire: {
          reference: this.candleTwoFireRef,
          className: ["candle2__fire", "candle2__fire-transition__on"],
        },
        candleOneSmokeOne: {
          reference: this.candleOneSmokeOneRef,
          className: [],
  ...
  public transitionCandleFireToOff = () => {
    if (
      this.state.currentCandleState === "On" ||
      this.state.currentCandleState === "Transitioning"
    ) {
      this.updateCandleState("Transitioning");

      Object.entries(this.state.fireOffTransitionState).forEach(
        ([key, value]) => {
  ...
  public transitionCandleFireToOn = () => {
    if (
      this.state.currentCandleState === "Off" ||
      this.state.currentCandleState === "Transitioning"
    ) {
      this.updateCandleState("Transitioning");

      Object.entries(this.state.fireOnTransitionState).forEach(
        ([key, value]) => {
          this.changeRefClassName(value.reference, value.className);
        },
      );
          ...
          <div className="candle1" ref={this.candleOneRef}>
            <div className="candle1__body">
              <div className="candle1__eyes">
                <span
                  className="candle1__eyes-one"
                  ref={this.candleOneEyesOneRef}
                ></span>
                <span
                  className="candle1__eyes-two"
                  ref={this.candleOneEyesTwoRef}
                ></span>
              </div>
              <div
                className="candle1__mouth"
                ref={this.candleOneMouthRef}
              ></div>
            </div>
          ...
          <div ref={this.candleTwoRef} className="candle2">
            <div className="candle2__body">
              <div className="candle2__eyes">
                <div
                  ref={this.candleTwoEyesOneRef}
                  className="candle2__eyes-one"
                ></div>
                <div
                  ref={this.candleTwoEyesTwoRef}
                  className="candle2__eyes-two"
                ></div>
              </div>
            </div>
