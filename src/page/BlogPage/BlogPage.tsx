            ...
            <article className="blog-container flex w-full">
                <section className="blog-list flex flex-col w-full items-center">
                    <div className="flex flex-row items-center justify-evenly">
                        <ul className="blog__tag-container flex justify-center flex-wrap">{renderUnSelectedTags()}</ul> {state.content.length > 0 && renderDisplayLeetCodePostsToggleButton()} </div>
