...
const getHTMLElementCenterYPosition = (
    element: any,
    offset: number = 0,
): number => {
    const rect = element.getBoundingClientRect();
...
function isCloseToAnotherElement(
    element: Element,
    detectStrategy: "top" | "bottom" | "both",
    proxmityToSenseAt: number = 100,
...
const adjustElementPositionAbsoluteY = (
    element: HTMLElement,
    y: number = 0,
): void => {
...
export {
    ...
    adjustElementPositionAbsoluteY as centerElementInParent,
